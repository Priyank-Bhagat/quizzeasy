import 'package:quizzeasy/question.dart';
...
class QuizBrain {
  int _temp = 0; //used to keep count of question
  final List<Questions> _quest =[
  ...
  bool endCheck(){
    if(_temp>=_quest.length - 1 ){
      print('user reached end of quiz');
      return true;
    }
    else{
      return false;
  ...
  String getQues(){
    ...
    return QuizBrain()._quest[_temp].ques;
  }

  bool getAns (){
    return QuizBrain()._quest[_temp].quesans;
  }
